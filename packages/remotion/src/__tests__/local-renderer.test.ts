...
// We MUST pass through ALL fs functions we don't mock, including mkdtempSync and readFileSync,
// so other test files (asset-generator, captions, prompt-loader) still work.
vi.mock('fs', () => {
