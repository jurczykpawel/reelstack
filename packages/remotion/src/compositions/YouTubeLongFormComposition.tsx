...
export const YouTubeLongFormComposition: React.FC<YouTubeProps> = ({
  ...
  const activeFullscreenChapter = chapters.find(
    (ch) => currentTime >= ch.startTime && currentTime < ch.endTime && (ch.style ?? 'fullscreen') === 'fullscreen',
  );
    ...
    if (layout === 'horizontal-split') {
      return (
        <HorizontalSplitLayout
          leftVideoUrl={primaryVideoUrl}
          rightVideoUrl={secondaryVideoUrl}
        />
      );
    }
