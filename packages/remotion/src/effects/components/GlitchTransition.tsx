...
export const GlitchTransition: React.FC<Props> = ({ segment }) => {
  ...
  const intensity = localFrame <= midpoint
    ? interpolate(localFrame, [0, midpoint], [0, 1], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' })
    : interpolate(localFrame, [midpoint, durationFrames], [1, 0], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' });
